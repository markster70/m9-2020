            ...
            <div class="mn-section-projects-inner carousel" id="js-projects-summary-container">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/zishi.php" data-content="/projects/includes/zishi-content.html" class="mn-project-grid-item-content mn-project-grid-item-trigger" aria-controls="case-study-wrapper">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">HR Application for Financial Organisation</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/frotcom.php" data-content="/projects/includes/frotcom-content.html" aria-controls="case-study-wrapper" class="mn-project-grid-item-content mn-project-grid-item-trigger">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">Wordpress Development for Haulage Business</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/body-face.php" data-content="/projects/includes/body-face-content.html" class="mn-project-grid-item-content mn-project-grid-item-trigger" aria-controls="case-study-wrapper">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">E-Commerce Website for Beauty Boutique</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/mpp.php" data-content="/projects/includes/mpp-content.html" class="mn-project-grid-item-content mn-project-grid-item-trigger" aria-controls="case-study-wrapper">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">Wordpress Development for Photography Business</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/collective.php" data-content="/projects/includes/collective-content.html"  class="mn-project-grid-item-content mn-project-grid-item-trigger" aria-controls="case-study-wrapper">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">Microsite Development for Digital Agency</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
                ...
                <article class="mn-project-grid-item carousel-cell">
                    <a href="/projects/barclays.php" data-content="/projects/includes/barclays-content.html" class="mn-project-grid-item-content mn-project-grid-item-trigger" aria-controls="case-study-wrapper">
                        ...
                        <div class="mn-project-grid-item-inner">
                            <div class="mn-project-grid-item-title-el">
                                <h4 class="mn-project-grid-item-title">Front-End Development for International Bank</h4>
                            </div>
                            <div class="mn-project-grid-item-link">
                                <p>View Case Study</p>
                                <img src="/dist/images/project-images/project-view-detail-icon.png" alt="view project">
        ...
        <nav>
            <button class="mn-projects-summary-detail-close">
                <svg viewBox="0 0 91 113.75">
                    <g>
                        <path d="M46,74.5c15.3,0,27.8-12.5,27.8-27.8c0-15.3-12.5-27.8-27.8-27.8c-15.4,0-27.8,12.5-27.8,27.8C18.2,62,30.7,74.5,46,74.5z    M32.9,36.2c-0.7-0.7-0.7-1.9,0-2.7c0.7-0.7,1.9-0.7,2.7,0L46,44l10.5-10.5c0.7-0.7,1.9-0.7,2.7,0c0.7,0.7,0.7,1.9,0,2.7L48.7,46.6   l10.5,10.5c0.7,0.7,0.7,1.9,0,2.7c-0.4,0.4-0.8,0.5-1.3,0.5s-1-0.2-1.3-0.5L46,49.3L35.5,59.8c-0.4,0.4-0.8,0.5-1.3,0.5   s-1-0.2-1.3-0.5c-0.7-0.7-0.7-1.9,0-2.7l10.5-10.5L32.9,36.2z"/>
                    </g>
                </svg>
                <span class="screen-reader-text">back to project summaries</span>
            </button>
        </nav>
        <div class="mn-project-grid-item-cs-wrap-inner">
            <!-- ajax'ed case studies come in here-->
        </div>
    </aside>
</section>